...
CREATE TABLE `environment_history` (
                           ...
                           `downgraded` varchar(5000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
                           `installed` varchar(5000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
                           `uninstalled` varchar(5000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
                           `upgraded` varchar(5000) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL,
                           ...
                           CONSTRAINT `env_user_fk` FOREIGN KEY (`user`) REFERENCES `users` (`uid`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=ndbcluster DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs
